...
import { Calendar, Users, CreditCard, MessageSquare, Mail, QrCode, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {modules.map((m, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 + i * 0.1 }} className="glass-card rounded-xl p-5 hover:shadow-warm transition-all cursor-pointer group">
