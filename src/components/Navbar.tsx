      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden overflow-hidden border-t border-primary-foreground/10 bg-primary"
          >
            <div className="px-4 py-4 flex flex-col gap-3">
              ...
              <Link to="/login" className="text-sm py-2 text-center rounded-lg bg-accent text-accent-foreground font-medium hover:bg-deep-brown hover:text-primary-foreground" onClick={() => setIsOpen(false)}>
                {isEn ? 'Admin Login' : 'Ingia Admin'}
              </Link>
            </div>
          </motion.div>
