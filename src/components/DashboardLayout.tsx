...
import { Calendar, Users, CreditCard, MessageSquare, Mail, QrCode, LogOut, LayoutDashboard, BarChart3, Wallet, FileText, Package, Globe, MessageCircle, Quote, Trash2, UserCog, Coins, Landmark, ShoppingCart } from 'lucide-react';
...
<img src="/smart-events-logo.png" alt="Smart Events" className="w-14 h-auto" />
      ...
      <div className="flex-1 flex flex-col">
        <header className="md:hidden border-b border-border bg-card px-3 py-2">
          <div className="flex items-center justify-between mb-2">
            <Link to="/" className="flex items-center gap-2">
<img src="/smart-events-logo.png" alt="Smart Events" className="w-12 h-auto" />
