...
const ContactForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // For now just show success - backend will be added with Cloud
    ...
    <section id="contact" className="py-24 bg-gradient-warm">
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full py-3.5 rounded-lg bg-primary text-primary-foreground font-semibold hover:bg-accent transition-colors shadow-warm"
          >
            {t('contact.submit')}
          </button>
